...
var require_cjs = __commonJS({
  "node_modules/kolorist/dist/cjs/index.js"(exports) {
    "use strict";
...
var require_sortDependencies = __commonJS({
  "utils/sortDependencies.js"(exports, module2) {
    module2.exports = function sortDependencies(packageJson) {
      ...
      return __spreadProps(__spreadValues({}, packageJson), {
        sorted
      });
    };
  }
...
var require_deepMerge = __commonJS({
  "utils/deepMerge.js"(exports, module2) {
...
var require_renderTemplate = __commonJS({
  "utils/renderTemplate.js"(exports, module2) {
    ...
    var sortDependencies = require_sortDependencies();
    var deepMerge = require_deepMerge();
    function renderTemplate2(src, dest) {
      ...
      if (filename === "package.json" && fs2.existsSync(dest)) {
        const existing = JSON.parse(fs2.readFileSync(dest));
        const newPackage = JSON.parse(fs2.readFileSync(src));
    ...
    module2.exports = renderTemplate2;
  }
});

// template/eslint/package.json
var require_package = __commonJS({
  "template/eslint/package.json"(exports, module2) {
    module2.exports = {
      devDependencies: {
...
var require_renderEslint = __commonJS({
  "utils/renderEslint.js"(exports, module2) {
    var fs2 = require("fs");
    var path2 = require("path");
    var sortDependencies = require_sortDependencies();
    var deepMerge = require_deepMerge();
    var { devDependencies: allEslintDeps } = require_package();
    var dependencies = {};
    ...
    function connfigureEslint({
      ...
      switch (`${styleGuide}-${language}`) {
        ...
        case "default-typescript":
          ...
          config.extends.push("eslint:recommended", "@vue/eslint-config-typescript/recommended");
          break;
      }
      if (needPrettier) {
...
`;
    ...
    module2.exports = function renderEslint2(rootDir, { needTypeScript, needCypress, needCypressCT, needPrettier }) {
      const { dependencies: dependencies2, configuration } = connfigureEslint({
      ...
      const existingPkg = JSON.parse(fs2.readFileSync(packageJsonPath, "utf-8"));
      const pkg = sortDependencies(deepMerge(existingPkg, {
        scripts: {
          lint: needTypeScript ? "eslint . --ext .vue,.ts,.tsx,.js,.jsx,.cts,.mts,.cjs,.mjs --fix --ignore-path .gitignore" : "eslint . --ext .vue,.js,.jsx,.cjs,.mjs --fix --ignore-path .gitignore"
        },
        devDependencies: dependencies2
      }));
      fs2.writeFileSync(packageJsonPath, JSON.stringify(pkg, null, 2) + "\n");
      const eslintrcPath = path2.resolve(rootDir, ".eslintrc.js");
      fs2.writeFileSync(eslintrcPath, configuration);
    };
  }
});

// utils/directoryTraverse.js
var require_directoryTraverse = __commonJS({
  "utils/directoryTraverse.js"(exports, module2) {
    var fs2 = require("fs");
    var path2 = require("path");
    function preOrderDirectoryTraverse2(dir, dirCallback, fileCallback) {
      for (const filename of fs2.readdirSync(dir)) {
        ...
        if (fs2.lstatSync(fullPath).isDirectory()) {
          ...
          if (fs2.existsSync(fullPath)) {
            preOrderDirectoryTraverse2(fullPath, dirCallback, fileCallback);
          }
          continue;
        }
    ...
    function postOrderDirectoryTraverse2(dir, dirCallback, fileCallback) {
      for (const filename of fs2.readFileSync(dir)) {
        const fullpath = fs2.resolve(dir, filename);
        if (fs2.lstatSync(fullpath).isDirectory()) {
          postOrderDirectoryTraverse2(fullpath, dirCallback, fileCallback);
          dirCallback(fullpath);
          continue;
        }
        fileCallback(fullpath);
    ...
    module2.exports = {
      preOrderDirectoryTraverse: preOrderDirectoryTraverse2,
      postOrderDirectoryTraverse: postOrderDirectoryTraverse2
    };
  }
});
...
var require_getCommand = __commonJS({
  "utils/getCommand.js"(exports, module2) {
    module2.exports = function getCommand2(packageManager, scriptName) {
...
var require_generateReadme = __commonJS({
  "utils/generateReadme.js"(exports, module2) {
    var fs2 = require("fs");
    var path2 = require("path");
    var getCommand2 = require_getCommand();
    ...
    module2.exports = function generateReadme2({
      projectName,
      packageManager,
      needTypeScript,
      needCypress,
...
${needTypeScript ? sfcTypeSupportDoc : ""}
...
## Project Setup
  ...
  ${getCommand2(packageManager, "install")}
  \`\`\`

  ### Compile and Hot-Reload for Development

  \`\`\`sh
  ${getCommand2(packageManager, "dev")}
  \`\`\`

  ### ${needTypeScript ? "Type-Check, " : ""}Compile and Minify for Production
  \`\`\`sh
  ${getCommand2(packageManager, "build")}
  \`\`\`
  `;
      if (needTypeScript) {
      ...
      \`\`\`sh
    ${getCommand2(packageManager, "test:unit")}
    \`\`\`
      `;
      }
      if (needCypress) {
      ...
      \`\`\`sh
      ${getCommand2(packageManager, "build")}
      ${getCommand2(packageManager, "test:e2e")} # or \`${getCommand2(packageManager, "test:e2e:ci")}\` for headless testing
      \`\`\`
      `;
      }
      if (needEslint) {
    ...
    \`\`\`sh
    ${getCommand2(packageManager, "lint")}
    \`\`\`
      `;
      }
...
var { red, green, bold } = require_cjs();
var banner = require_banner();
var renderTemplate = require_renderTemplate();
var renderEslint = require_renderEslint();
var {
  preOrderDirectoryTraverse,
  postOrderDirectoryTraverse
} = require_directoryTraverse();
var generateReadme = require_generateReadme();
var getCommand = require_getCommand();
...
function emptyDir(dir) {
  ...
  postOrderDirectoryTraverse(dir, (dir2) => fs.rmdirSync(dir2), (file) => fs.unlinkSync(file));
}
async function init() {
  console.log(`
${banner}
`);
  ...
  try {
    result = await prompts([
      ...
      },
      {
        ...
        type: () => canSafeOverwrite(targetDir) || forceOverwrite ? null : "confirm",
        message: () => {
      ...
      },
      {
        ...
        validate: (dir) => isVaidPackageName(dir) ? true : `Package name ${dir} is invalid`
      },
      {
        name: "needTypeScript",
      ...
      },
      {
        name: "needCypress",
        type: () => isFeatureFlagsUsed ? null : "toggle",
        message: (prev, answers) => answers.needVitest ? "Add Cypress for E2E testing?" : "Add Cypress for both Unit and E2E testing?",
        initial: false,
        active: "Yes",
        inactive: "No"
      },
 ...
 Scaffolding project in ${root}...`);
    ...
    const codeTemplate = (needTypeScript ? "typescript-" : "") + (needVueRouter ? "router" : "default");
